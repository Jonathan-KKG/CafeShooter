...
public class Config {
    ...
    public final static String WINDOW_TITLE = "Café Shooter, Inc.";
    ...
    public final static int WINDOW_HEIGHT = 1109;   // Effektive Höhe ist etwa 29 Pixel geringer (Titelleiste wird mitgezählt)
